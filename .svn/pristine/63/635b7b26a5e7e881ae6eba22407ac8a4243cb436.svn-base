...
function slctCountry(obj) {
	/*
	 * if (obj.value != "中国") { document.shareip.province.style.visibility =
	 * "hidden"; document.shareip.city.style.visibility = "hidden";
	 * document.shareip.town.style.visibility = "hidden"; } else {
